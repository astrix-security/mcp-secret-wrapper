...
[![Build Status](https://img.shields.io/github/actions/workflow/status/astrix-security/mcp-secret-wrapper/publish.yml?branch=main)](https://github.com/astrix-security/mcp-secret-wrapper/actions)
